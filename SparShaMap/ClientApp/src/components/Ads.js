                    ...
                    <div>
                        ...
                        <p className='clearfix'>
                            ...
                            <div className="text-right">
                                {prevStartDateIndex > 0 ? <Link className='btn btn-default pull-left' to={`/Ads/${prevStartDateIndex}`}><Button color="primary">ก่อนหน้า</Button></Link> : ""}
                                {/*ต้อง Check จาก total page*/}
                                <Link className='btn btn-default pull-right' to={`/Ads/${nextStartDateIndex}`}><Button color="primary">ถัดไป</Button></Link>
                            </div>
                        </p>
                    </div>
                }
...
function renderPagination(props) {
    ...
    return <p className='clearfix text-center'>
        <Link className='btn btn-default pull-left' to={`/Ads/${prevStartDateIndex}`}>Previous</Link>
        <Link className='btn btn-default pull-right' to={`/Ads/${nextStartDateIndex}`}>Next</Link>

...
class Users extends Component {
    ...
    render() {
        const index = this.props.startDateIndex;
                    ...
                    <tbody>
                        ...
                        <p className='clearfix'>
                            ...
                            <div className="text-right">
                                {index > 0 ? <Link className='btn btn-default pull-left' to={`/Users/${prevStartDateIndex}`}><Button color="primary">ก่อนหน้า</Button></Link> : ""}
                                {/*ต้อง Check จาก total page*/}
                                <Link className='btn btn-default pull-right' to={`/Users/${nextStartDateIndex}`}><Button color="primary">ถัดไป</Button></Link>
                            </div>
                    </p>
                    </div>
                }
